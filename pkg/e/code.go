...
const (
	...
	ERROR_DEVICE_CONTAINER_RUN_FIRST                = 3009
	ERROR_DEVICE_GET_CONTAINER_FAIL                 = 3010
	ERROR_DEVICE_START_CONTAINER                    = 3011
	ERROR_DEVICE_STATUS_START_STOP_CONTAINER        = 3012
	ERROR_DEVICE_UPDATE_STATUS_START_STOP_CONTAINER = 3013
	ERROR_DEVICE_SQL_CHECK_CONNECTED                = 3014
	ERROR_DEVICE_CHECK_CONNECTED                    = 3015
	ERROR_DEVICE_SQL_DELETE_CONTAINER               = 3016
	ERROR_DEVICE_CHECK_DELETE_CONTAINER             = 3017
	ERROR_DEVICE_SQL_DELETE_IMAGE                   = 3018
	ERROR_DEVICE_CHECK_DELETE_IMAGE                 = 3019
	ERROR_DEVICE_GET_MACHINE_ID_FROM_IMAGE_ID       = 3020
	ERROR_DEVICE_GET_IMAGE_FAIL                     = 3021
	ERROR_DEVICE_UPDATE_STATUS_DELETE_IMAGE         = 3022
